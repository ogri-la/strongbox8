...
namespace eval ttk::theme::parade {

    package provide ttk::theme::parade 0.1
    ...
    array set I [LoadImages \
                     [file join [file dirname [info script]] parade] *.gif]
    ...
    ttk::style theme create parade -parent clam -settings {
...
#             -map [list selected $I(tab-n)]
        ...
        ttk::style map TNotebook.Tab \
            ...
            -font [list selected {TkDefaultFont 0 normal}] \
            ;
